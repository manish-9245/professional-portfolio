    ...
    const shareActionsHtml = `
      ...
      <div class="blog-share-actions">
        ...
        <a class="blog-share-link share-whatsapp" aria-label="Share on WhatsApp" title="Share on WhatsApp" target="_blank" rel="noopener noreferrer" href="https://api.whatsapp.com/send?text=${encodeURIComponent(title + " " + pageUrl)}">
          <svg class="blog-share-icon" viewBox="0 0 24 24"><path d="M.057 24l1.687-6.163c-1.041-1.804-1.588-3.849-1.588-5.946 0-6.556 5.332-11.888 11.888-11.888 3.176 0 6.161 1.237 8.404 3.48 2.242 2.242 3.48 5.227 3.48 8.403 0 6.557-5.332 11.888-11.888 11.888-2.097 0-4.141-.548-5.945-1.587L0 .057zm12.862-21.063c-4.993 0-9.057 4.064-9.057 9.057 0 1.614.42 3.186 1.217 4.567l.131.227-1.011 3.693 3.779-.991.22.13c1.325.785 2.846 1.2 4.417 1.2 4.993 0 9.057-4.064 9.057-9.057 0-2.42-.942-4.695-2.653-6.406-1.71-1.713-3.986-2.653-6.406-2.653zm4.966 12.073c-.272-.136-1.608-.793-1.857-.883-.25-.089-.432-.136-.613.136-.181.271-.703.883-.862 1.063-.158.181-.317.204-.589.068-.272-.136-1.147-.423-2.185-1.347-.808-.72-1.353-1.611-1.512-1.882-.158-.271-.017-.417.119-.552.122-.122.272-.317.408-.475.136-.158.181-.271.272-.452.09-.181.045-.339-.023-.475-.068-.136-.613-1.477-.84-2.02-.221-.53-.443-.459-.613-.468-.158-.009-.339-.009-.521-.009s-.475.068-.724.339c-.249.271-.951.928-.951 2.261s.974 2.623 1.11 2.804c.136.181 1.918 2.928 4.646 4.103.648.279 1.156.446 1.551.572.653.208 1.248.179 1.718.109.525-.078 1.608-.657 1.835-1.289.227-.633.227-1.177.158-1.289-.069-.112-.25-.181-.522-.317z"/></svg>
          <span>WhatsApp</span>
        </a>
